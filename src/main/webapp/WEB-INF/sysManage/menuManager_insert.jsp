            ...
            <form class="layui-form" action="" lay-filter="component-form-group" type="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="mName" lay-verify="required" autocomplete="off" placeholder="请输入菜单名称"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="mUrl" lay-verify="required" autocomplete="off" placeholder="请输入菜单url路径"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="mIcon" lay-verify="required" autocomplete="off" placeholder="请输入菜单url路径"
                               class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("<%=request.getContextPath()%>/bg/menu_manager/to_insert", data.field, function (data) {
                // 获取 session
