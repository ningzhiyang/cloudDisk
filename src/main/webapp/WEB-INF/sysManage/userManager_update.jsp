    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body" style="padding: 15px;">
            <form class="layui-form" action="" lay-filter="component-form-group" type="">
                ...
                <input name="uId" type="hidden" value="${sysUser.UId}">
                <div class="layui-form-item">
                    <label class="layui-form-label">管理员图片</label>
                    <div class="layui-input-inline">
                        <input name="uImg" lay-verify="required" id="activity_pic" placeholder="图片地址"
                               class="layui-input" value="${sysUser.UImg}">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="uAccount" lay-verify="required" autocomplete="off" placeholder="请输入用户名"
                               class="layui-input" value="${sysUser.username}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">密码</label>
                    <div class="layui-input-block">
                        <input type="text" name="uPassword" lay-verify="required" autocomplete="off" placeholder="请输入密码"
                               class="layui-input" value="${sysUser.UPassword}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">登录Ip</label>
                    <div class="layui-input-block">
                        <input type="text" name="uIp" autocomplete="off" placeholder="登录Ip"
                               class="layui-input" value="${sysUser.UIp}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">登录时间</label>
                    <div class="layui-input-block">
                        <input type="text" name="uLoginTime" autocomplete="off" placeholder="登录时间"
                               class="layui-input" value="${sysUser.ULoginTime}" disabled>
                    </div>
                </div>
                <!--<div class="layui-form-item">
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("<%=request.getContextPath()%>/bg/user_manager/to_update", data.field, function (data) {
                // 获取 session
...
<script src="/cloud/layuiadmin/js/jquery-3.4.1.min.js"></script>
<script>
    function show_img() {
        var $ = layui.$;
