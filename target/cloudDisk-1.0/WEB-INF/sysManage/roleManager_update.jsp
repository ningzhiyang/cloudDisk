                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="rName" lay-verify="required" autocomplete="off" placeholder="请输入角色名称"
                               class="layui-input"  value="${sysRole.RName}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="rDetail" lay-verify="required" autocomplete="off" placeholder="请输入角色备注"
                               class="layui-input" value="${sysRole.RDetail}">
                    </div>
                </div>
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("<%=request.getContextPath()%>/bg/role_manager/to_update", data.field, function (data) {
                // 获取 session
