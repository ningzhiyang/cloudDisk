                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="vPhone" lay-verify="required" autocomplete="off" placeholder="请输入用户手机号"
                               class="layui-input" value="${vueUser.VPhone}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">用户账号</label>
                    <div class="layui-input-block">
                        <input type="text" name="vAccount" lay-verify="required" autocomplete="off" placeholder="请输入用户账号"
                               class="layui-input" value="${vueUser.VAccount}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="vPwd" lay-verify="required" autocomplete="off" placeholder="请输入密码"
                               class="layui-input" value="${vueUser.VPwd}">
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">登录Ip</label>
                    <div class="layui-input-block">
                        <input type="text" name="vLoginIp" autocomplete="off" placeholder="登录Ip"
                               class="layui-input" value="${vueUser.VLoginIp}" disabled>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">登录时间</label>
                    <div class="layui-input-block">
                        <input type="text" name="vLoginTime" autocomplete="off" placeholder="登录时间"
                               class="layui-input" value="${vueUser.VLoginTime}" disabled>
                    </div>
                </div>
...
<script>
    layui.config({
        ...
        form.on('submit(component-form-demo)', function (data) {
            $.post("<%=request.getContextPath()%>/bg/vue_user_manager/to_update", data.field, function (data) {
                // 获取 session
